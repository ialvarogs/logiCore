...
import { obtenerProductosMasAsignados } from "~~/server/utils/repositories/reportes";
...
export default defineEventHandler(async (event) => {
  ...
  try {
    // Llama a la función obtenerProductosMasAsignados para obtener los datos del gráfico
